...
## A word from someone with 1000+ hours in this game

Being max level doesn't make you good at KF2. Perk level is a number that goes up over time, it has nothing to do with knowing how to control your lane, to kite, takedown ZEDs, communicate with your team, or not die to a Fleshpound you saw coming from a mile away. Skill comes from actually playing hard content, not from standing in a killbox letting a script throw grenades for you.

If you use this tool instead of putting in the actual reps, you're not cheating a system, you're cheating yourself out of getting good. And it doesn't stay contained to you, if you take that hollow level into a real lobby on Suicidal/HoE/CD, other players are now relying on someone whose perk level says "experienced" but whose actual game sense doesn't back it up. That's how people get wiped LOL.

Use this to skip the boring grind if you want, that's your call. Just don't let the number fool you into thinking it means something it doesn't, and don't take it into content you're not actually ready for.
